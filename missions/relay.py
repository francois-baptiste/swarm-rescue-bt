...
SCENARIOS = {
    ...
    "double_failure": dict(
        description="Same map, but 2 of the 3 relay robots fail (ticks 25 and 35) - only the "
                     "robot closest to the source survives, leaving a huge unbridged gap to the "
                     "sink instead of one broken link.",
        width=15, height=15,
        source=(0, 0), sink=(14, 14),
        starts=[(0, 0), (0, 0), (0, 0)],
        comm_range=6.0,
